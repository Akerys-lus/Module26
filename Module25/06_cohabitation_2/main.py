...
class House:
    ...
    def life(self):
        # TODO это не геттер, он ничего не возвращает.
        """
        Геттер отвечающий за выполнение ежедневных действий жильцами

        """
        # TODO А что будет если разновидностей жителей будет 25? Какой величины станет код метода? Разнесите код по
        #  конкретным классам жителей в методы "действовать" (act), вызывайте этот метод для каждого жителя в основном
        #  коде программы, в годовом цикле
